...
- /dashboard/ai/{model_id} sinh form dựa trên app/services/model_registry.py, kèm tooltip giải thích trường, nút **Load sample data** và tải JSON/CSV mẫu để QA gõ thử ngay.
- Bộ test normal/edge/error và sample payload chính thức nằm trong [docs/AI_MODEL_PREDICTION_TEST_PLAN.md](docs/AI_MODEL_PREDICTION_TEST_PLAN.md); hãy tham chiếu tài liệu này trước khi chạy regression cho từng mô hình.# DIGITALTWINOPS – NỀN TẢNG AI VẬN HÀNH SUPPLY CHAIN SỐ HOÁ 🚀
...
- /dashboard/ai/{model_id} sinh form dựa trên app/services/model_registry.py, kèm tooltip giải thích trường, nút **Load sample data** và tải JSON/CSV mẫu để QA gõ thử ngay.
- Bộ test normal/edge/error và sample payload chính thức nằm trong [docs/AI_MODEL_PREDICTION_TEST_PLAN.md](docs/AI_MODEL_PREDICTION_TEST_PLAN.md); hãy tham chiếu tài liệu này trước khi chạy regression cho từng mô hình.